...
DUCKDNS_TOKEN=$(curl -sf -H "Metadata-Flavor: Google" "${METADATA_URL}/attributes/duckdns-token")
DUCKDNS_DOMAIN=$(curl -sf -H "Metadata-Flavor: Google" "${METADATA_URL}/attributes/duckdns-domain")
